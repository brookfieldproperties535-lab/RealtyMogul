...
@section('content')
        <main>
            ...
            <section class="breadcum v1">
                ...
                <div class="bg-shap-1" data-background="{{ asset('user/assets/img/breadcum/v1/bg-shap.html') }}"></div>
                <div class="bg-shap-2" data-background="{{ asset('user/assets/img/breadcum/v1/img-1.html') }}"></div>
                <div class="bg-shap-3" data-background="{{ asset('user/assets/img/breadcum/v1/img-2.html') }}"></div>
            </section>
            <!-- Breadcum End -->
            <!-- About Us Start -->
                ...
                <div class="container">
                    <div class="section-title v1">
                        ...
                        <span class="about-title-shap wow animate__bounceIn" data-wow-offset="100" data-wow-delay="0.1s"
                            ...
                            <img src="{{ asset('user/assets/img/about-us/trigger-n-alerts.html') }}" alt="trigger-n-alerts">
                        </span>
                    </div>
                    <div class="row">
                        <div class="col-xl-6 col-xxl-5">
                            <div class="about-profile">
                                ...
                                <img src="{{ asset('user/assets/img/about-us/paly-video-img.html') }}" alt="paly-video-img">
                            </div>
                        </div>
            ...
            <section class="our-values v1 pt-sm-50 pb-sm-50 pt-130 pb-130 pt-md-70 pb-md-70 pt-lg-100 pb-lg-100">
                ...
                <div class="bg-shap" data-background="{{ asset('user/assets/img/our-values/v1/bg-shap.html') }}"></div>
            </section>
            <!-- Our Values End -->
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="banking-card-img">
                                <img src="{{ asset('user/assets/img/banking-experience-card/banking-card-img.html') }}"
                ...
                <div class="container">
                    ...
                    <div class="row">
                        <div class="col-md-6 col-lg-3 wow animate__fadeInUp" data-wow-offset="100" data-wow-delay="0.1s"
                            ...
                            <div class="the-founder-card">
                                <div class="founder-card-img">
                                    <img src="{{ asset('user/assets/img/the-founders-img/team-img-1.html') }}" alt="founders-img">
                                </div>
                        ...
                        <div class="col-md-6 col-lg-3 wow animate__fadeInUp" data-wow-offset="100" data-wow-delay="0.3s"
                            ...
                            <div class="the-founder-card">
                                <div class="founder-card-img">
                                    <img src="{{ asset('user/assets/img/the-founders-img/team-img-2.html') }}" alt="founders-img">
                                </div>
                                <div class="card-contant">
                                    <div class="card-text">
                                        <h4><a href="#">Aaron Hyde</a></h4>
                        ...
                        <div class="col-md-6 col-lg-3 wow animate__fadeInUp" data-wow-offset="100" data-wow-delay="0.5s"
                            ...
                            <div class="the-founder-card">
                                <div class="founder-card-img">
                                    <img src="{{ asset('user/assets/img/the-founders-img/team-img-3.html') }}" alt="founders-img">
                                </div>
                                <div class="card-contant">
                                    <div class="card-text">
                                        <h4><a href="#">Aaron Hyde</a></h4>
                        ...
                        <div class="col-md-6 col-lg-3 wow animate__fadeInUp" data-wow-offset="100" data-wow-delay="0.7s"
                            ...
                            <div class="the-founder-card">
                                <div class="founder-card-img">
                                    <img src="user/assets/img/the-founders-img/team-img-4.html" alt="founders-img">
                                </div>
                                <div class="card-contant">
                                    <div class="card-text">
                                        <h4><a href="#">Aaron Hyde</a></h4>
