...
<head>
    ...
    <title>@yield('title', 'Dashboard') – RealtyMogul Admin</title>
    <!-- Custom CSS -->
...
<body>
    ...
    <div id="main-wrapper">
                    ...
                    <div class="navbar-brand">
                        <a href="{{ route('admin.dashboard') }}" class="logo"
                           style="display:flex;align-items:center;padding:4px 0;">
                            <img src="{{ asset('admin/assets/images/RealityMogul.png') }}"
                                 alt="RealtyMogul"
                    ...
                    <ul id="sidebarnav">
                        ...
                        <li class="sidebar-item"> <a class="sidebar-link has-arrow waves-effect waves-dark"
                            ...
                            <ul aria-expanded="false" class="collapse first-level">
                                <li class="sidebar-item"><a href="/admin/add-client" class="sidebar-link"><i
                                            class="mdi mdi-priority-low"></i><span class="hide-menu"> Add New
                                            Client</span></a></li>
                                <li class="sidebar-item"><a href="/admin/clients" class="sidebar-link"><i
        ...
        <footer class="footer text-center">
            All Rights Reserved by Realty Mogul. Designed and Developed by
            <a href="https://realtymogul.com">Realty Mogul</a>.
        </footer>
        <!-- ============================================================== -->
        <!-- End footer -->
        <!-- ============================================================== -->
