...
Route::view('/user-login', 'users.login')->name('user.login');
Route::view('/user-register', 'users.register')->name('user.register');
...
// Public information / marketing pages
Route::view('/contact-us', 'users.contact')->name('users.contact');
Route::view('/about-us', 'users.about')->name('users.about');
Route::view('/rm-1031-exchange', 'users.1031-exchange')->name('users.1031-exchange');
Route::view('/investment-opportunities', 'users.marketplace')->name('users.investment-opportunities');
Route::view('/rm-communities', 'users.rm-communities')->name('users.rm-communities');
Route::view('/knowledge-center', 'users.knowledge-center')->name('users.knowledge-center');
Route::view('/reits', 'users.reits')->name('users.reits');
Route::view('/income-reits', 'users.income-reits')->name('users.income-reits');
Route::view('/growth-reits', 'users.growth-reits')->name('users.growth-reits');
Route::view('/why-reits', 'users.why-reits')->name('users.why-reits');
Route::view('/research', 'users.research')->name('users.research');
Route::view('/due-diligence-process', 'users.due-diligence-process')->name('users.due-diligence-process');
Route::view('/investment-options', 'users.investment-options')->name('users.investment-options');
Route::view('/private-credit', 'users.private-credit')->name('users.private-credit');
Route::view('/why-commercial-real-estate', 'users.why-commercial-real-estate')->name('users.why-commercial-real-estate');
